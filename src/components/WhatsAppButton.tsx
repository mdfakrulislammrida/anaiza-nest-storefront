...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      // Raised clear of the sticky mobile Add to Cart / Buy Now bar on the
      // product page (present on every page, so this is uniform rather than
      // page-conditional -- the same pattern most sites use for a chat
      // bubble alongside a persistent bottom bar).
      className="fixed bottom-24 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 sm:bottom-5"
    >
